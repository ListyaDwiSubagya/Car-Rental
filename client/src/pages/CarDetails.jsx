...
const CarDetails = () => {
  ...
  return car ?  (
    <div className='px-6 md:px-16 lg:px-24 xl:px-32 mt-16 '>
        <button onClick={() => navigate(-1)} className='flex items-center cursor-pointer gap-2 mb-6 text-gray-500'>
        ...
        <div className='grid grid-cols-1 lg:grid-cols-3 gap-8 lg:gap-12'>
            ...
            {/* Right: Booking form */}
            <form onSubmit={handleSubmit} action="" className='shadow-lg h-max sticky top-18 rounded-xl p-6 space-y-6
            text-gray-500'>
                ...
                <div className='flex flex-col gap-2'>
                    ...
                    <input type="date" className='border border-borderColor px-3 
                    py-2 rounded-lg' required id='pickup-date' min={new Date().toLocaleString().
                        split('T')[0]
                    }/>
                </div>
                <div className='flex flex-col gap-2'>
                    ...
                    <input type="date" className='border border-borderColor px-3 
                    py-2 rounded-lg' required id='pickup-date' />
                </div>
