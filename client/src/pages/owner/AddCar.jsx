        ...
        text-sm mt-6 max-w-xl'>
            ...
            <div className='grid grid-cols-1 md:grid-cols-2 gap-6'>
                <div className='flex flex-col w-full'>
                    ...
                    value={car.brand} onChange={e => setCar({...car, brand:
                        e.target.value
                    })}/>
                </div>
                ...
                <div className='flex flex-col w-full'>
                    ...
                    className='px-3 py-2 mt-1 border border-borderColor rounded-md outline-none'
                    value={car.model} onChange={e => setCar({...car, model:
                        e.target.value
                    })}/>
                </div>  
            </div>
            ...
            <div className='grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-6'>
                <div className='flex flex-col w-full'>
                    ...
                    className='px-3 py-2 mt-1 border border-borderColor rounded-md outline-none'
                    value={car.year} onChange={e => setCar({...car, year:
                        e.target.value
                    })}/>
                </div>  
                <div className='flex flex-col w-full'>
                    ...
                    className='px-3 py-2 mt-1 border border-borderColor rounded-md outline-none'
                    value={car.pricePerday} onChange={e => setCar({...car, pricePerday:
                        e.target.value
                    })}/>
                </div>  
                <div className='flex flex-col w-full'>
                    <label >Category</label>
                    <select className='px-3 py-2 mt-1 border border-borderColor
                    rounded-md outline-none' onChange={e => setCar({...car, category:
                        e.target.value
                    })} value={car.category}>
            ...
            <div className='grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-6'>
                <div className='flex flex-col w-full'>
                    ...
                    <select className='px-3 py-2 mt-1 border border-borderColor
                    rounded-md outline-none' onChange={e => setCar({...car, transmission:
                        e.target.value
                ...
                <div className='flex flex-col w-full'>
                    ...
                    <select className='px-3 py-2 mt-1 border border-borderColor
                    rounded-md outline-none' onChange={e => setCar({...car, fuel_type:
                        e.target.value
                    })} value={car.fuel_type}>
                        ...
                        <option value="Electric">Eelectric</option>
                ...
                <div className='flex flex-col w-full'>
                    ...
                    className='px-3 py-2 mt-1 border border-borderColor rounded-md outline-none'
                    value={car.seating_capacity} onChange={e => setCar({...car, seating_capacity:
                        e.target.value
                    })}/>
                </div> 
            ...
            <div className='flex flex-col w-full'>
                ...
                className='px-3 py-2 mt-1 border border-borderColor rounded-md outline-none'
                value={car.description} onChange={e => setCar({...car, category:
                    e.target.value
                })}></textarea>
            </div>  
