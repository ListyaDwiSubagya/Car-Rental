...
const ManageBooking = () => {
  ...
  return (
    <div className='px-4 pt-10 md:px-10 w-full'>
        ...
        or cancel request, and manage booking statuses."/>
        ...
        <div className='max-w-3xl w-full rounded-md overflow-hidden border border-borderColor mt-6'>
            ...
            <tbody className=''>
                {bookings.map((booking, index) => (
                    <tr key={index} className='border-t border-t-borderColor text-gray-500'>
                       
                       <td className='p-3 flex items-center gap-3'>
                        <img src={booking.car.image} className='h-12 w-12 aspect-square rounded-md
                        object-cover' alt="" />
