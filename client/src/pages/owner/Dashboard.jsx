...
const Dashboard = () => {
  ...
  return (
    <div className='px-4 pt-10 md:px-10 flex-1'>
        <Title title="Admin Dashboard" subTitle="Monitor overall platform perfomance
        ...
        <div className='flex flex-wrap items-start gap-6 mb-8 w-full'>
                ...
                {data.recentBookings.map((bookings, index) => (
                    <div key={index} className='mt-4 flex items-center justify-between'>
                        <div className='flex items-center gap-2'>
                            ...
                            <div className=''>
                                <p className=''>{bookings.car.brand} {bookings.car.model}</p>
            ...
            md:max-w-xs'>
                ...
                <p className='text-gray-500'>Revenue for current moth</p>
